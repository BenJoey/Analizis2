...
Ha $f\in\D^{(n+1)}(K(a))$, akkor $\forall x\in K(a),\exists\xi\in(a,x):f(x)=
\sum\limits_{k=0}^{n}\frac{f^{(k)}(a)}{k!}(x-a)^k+\frac{f^{(n+1)}(\xi)}{(n+1)!}
(x-a)^{n+1}$\\[0.2cm]\biz
...
(x-a)^{k-2}\\[0.2cm]F''(a)=f''(a)-f''(a)\quad\Rightarrow\quad F^{(n)}(a)=0,\quad
