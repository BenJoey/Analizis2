...
\begin{enumerate}
	...
	$f$ szig. mon. nő és folytonos\\[0.1cm] $\Rightarrow$ az inverze is folytonos (az előző tételek alapján).\\[0.1cm] \defi $\sqrt[n]{} := f^{-1}$. Az $n$-edik
	gyökfüggvény.
	\item Logaritmusfüggyvény \\ \tetel Az $exp:\R\to\R^+$ szig. mon. nő folytonos
	és $\R_{exp}=\R_+$ \\[0.1cm] \biz Biz. nélkül\\[0.1cm]$\Rightarrow
	ln:=exp^{-1}$ fgv. is szig. mon. nő és folytonos.\\[0.1cm] \defi
	$ln:=exp^{-1}:\R_+\to\R$
	\item $a$ alapú exp. és logaritmikus függvények\\[0.1cm]\defi
	...
	konstans, ha $a=1$\\[0.1cm] \defi $\log_a=(exp_a)^{-1}:
	\R_+\to\R\quad(a>0,a\neq1)$
	\item $\alpha$ kitevőjű hatványfüggvény\\[0.1cm]\defi
...
\defi $a\in A\subset\R$ az $A$ belső pontja, ha $\exists K(a)\subset A\quad$
...
\end{itemize}
\defi Az $f\in\R\to\R$ deriválható (differenciálható) az $a\in int D_f$ pontban, ha
